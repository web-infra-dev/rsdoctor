...
| Artifact Alert | The ability to perform detection based on build artifact data | [Artifact Alert](../usage/bundle-alters)  |
| Compilation Alert | The ability to perform detection based on compilation data | [Compilation Alert](../usage/compile-alters) |
