...
| <b><i>font files</i></b>        | Represents the number of `.ttf`/`.fnt`/`.fon`/`.otf` files in the artifacts         |
...
- The **"TOTAL Size"** data on the card represents the total size of the project. Clicking on this number will navigate to the [Bundle Size page](){/* TODO:: add link */}.
