...
In this section, you can navigate to "Compile Analysis" -> "Loader Analysis" -> "Loader Overall" in the navigation bar to view the timeline of loader compilation time.
