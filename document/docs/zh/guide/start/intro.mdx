...
- 该模块主要提供了 Rspack / Webpack Loaders 内的输入输出、预估耗时、参数等数据分析的功能。

| ![Loader-timeline](https://lf3-static.bytednsdoc.com/obj/eden-cn/lognuvj/rsdoctor/docs/start/loader-timeline.jpg) | ![Loader-timeline](https://lf3-static.bytednsdoc.com/obj/eden-cn/lognuvj/rsdoctor/docs/start/loader-analysis.jpg) |
| ---------------------------------------------------------- | ------------------------------------------------ |
