...
Treemap is a classic artifact analysis view that helps developers more intuitively visualize and analyze bundle composition and the proportion of Assets and Modules.
