...
- **A smaller installation footprint**: Core capabilities are consolidated into `@rsdoctor/core`. With `V2`, a complete production install contains 18 packages instead of 83 and is **56.6%** smaller than 1.6.2.
...
| ---------------------------- | ------------: | ----------: | --------: | -------------: |
| Third-party dependency size  |       25.5 MB |     11.1 MB |   14.4 MB |      **56.6%** |
| Third-party dependency count |            83 |          18 |        65 |      **78.3%** |
