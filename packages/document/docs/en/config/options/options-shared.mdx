...
This is the options for the [RsdoctorRspackPlugin](./options#rsdoctorrspackplugin). It contains these properties:
...
- **lite**: Enables lite mode. Source and asset code are omitted while bundled module code is retained. Lite mode is disabled by default.
