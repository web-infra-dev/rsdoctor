...
Package migration does not automatically update removed configuration fields. Follow the [configuration migration guide](/config/options/options-v2) for `mode`, `brief`, `output.compressData`, and related output options.
