...
- `target_branch`: Optional, target branch name, defaults to 'main'. If you want to use a dynamic target branch, i.e., automatically get the target branch of the current MR instead of a fixed main branch, you can use the following configuration:
    ...
    steps:
      ...
      - name: Bundle Analysis
        ...
        with:
          ...
          # Default 'main'. If you want to use a dynamic target branch, i.e., automatically get the target branch of the current MR instead of a fixed main branch, you can use the following configuration:
