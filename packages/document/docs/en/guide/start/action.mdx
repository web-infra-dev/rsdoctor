...
**2. You need to use Brief mode and enable 'json' in the type array for uploading analysis data in subsequent GitHub Actions.** For specific configuration, see [output configuration](/config/options/output).
...
**Q: Baseline data not found**

- This is normal for first-time runs or new repositories
- The Action will still generate current bundle analysis
- Baseline data will be created after the first merge to the main branch
