...
A project may build web, Node.js, or worker bundles with separate compilers. Each build has its own output and dependencies, so analysis needs a clear target to avoid treating Node.js dependencies as web bundle size problems.
