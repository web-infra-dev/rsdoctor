...
Rsdoctor analyzes projects built with Rspack. For webpack projects, continue using Rsdoctor 1.x or migrate to Rspack. See the [migration guide](/guide/start/migration-v2) for details.
