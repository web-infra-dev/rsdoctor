...
Rsdoctor 2.x analyzes projects built with Rspack 2.x. For webpack projects, continue using Rsdoctor 1.x or migrate to Rspack before upgrading. See the [Rsdoctor 2.0 migration guide](/guide/start/migration-v2) for details.
...
- This module analyzes input and output, estimated execution time, and parameters for Rspack loaders.
