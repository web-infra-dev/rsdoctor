...
Rsdoctor 2.0 requires Node.js 20.19 or later and Rspack 2.0 or later. Rspack 1.x is no longer supported. webpack support and `@rsdoctor/webpack-plugin` have also been removed.
