...
**定义：**  
Rspack 会把多个模块（JS、CSS 等）打包成一个或多个文件，这些文件就是 bundle。一个 bundle 可能包含多个 Assets，例如：name 为 index 的 bundle 可能包含 index.js 和 index.css 两个产物。
...
| ------ | ----------- | ----------------------------------------------- |
| assets | 资源        | 最终产物，静态文件                              |
| bundle | 包/捆绑文件 | 输出的打包文件，一个 bundle 可能包含多个 assets |
