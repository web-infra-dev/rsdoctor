...
Rsdoctor 提供了官方的 GitHub [rsdoctor-action](https://github.com/web-infra-dev/rsdoctor-action) CI/CD 流程中轻松集成 Rsdoctor 分析功能。通过 GitHub Action，你可以在 Github 上每次构建时自动生成和对 Bundle 进行差异分析，进行 Bundle 劣化监控，持续优化项目性能。
