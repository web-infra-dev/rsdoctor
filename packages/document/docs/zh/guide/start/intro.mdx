...
Rsdoctor 2.x 用于分析基于 Rspack 2.x 构建的项目。webpack 项目应继续使用 Rsdoctor 1.x，或先迁移到 Rspack，再升级到 Rsdoctor 2.x。详情请参阅 [Rsdoctor 2.0 迁移指南](/guide/start/migration-v2)。
...
- 该模块用于分析 Rspack Loaders 的输入输出、预估耗时和参数等数据。
